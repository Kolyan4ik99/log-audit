...
var file_proto_notification_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x70, 0x6b, 0x67, 0x2f, 0x72, 0x70,
...
var file_proto_notification_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: notification.Request
	(*Response)(nil), // 1: notification.Response
}
var file_proto_notification_proto_depIdxs = []int32{
	0, // 0: notification.Notification.Send:input_type -> notification.Request
	1, // 1: notification.Notification.Send:output_type -> notification.Response
